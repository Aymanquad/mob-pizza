...
userSchema.index({ email: 1 }, { sparse: true, unique: true }); // Sparse index to allow multiple null emails
userSchema.index({ phone: 1 }, { sparse: true, unique: true }); // Sparse index to allow multiple null phones
userSchema.index({ googleId: 1 }, { sparse: true, unique: true }); // Sparse index to allow multiple null googleIds
